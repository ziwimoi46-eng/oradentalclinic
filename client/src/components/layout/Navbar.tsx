      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            <a href="tel:+919405717515" className="flex items-center gap-2 text-primary font-semibold hover:opacity-80 transition-opacity">
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[350px] bg-white border-l border-border/50">
              ...
              <div className="flex flex-col gap-8 mt-12">
                ...
                <div className="flex flex-col gap-4 mt-auto">
                  <a
                    href="tel:+919405717515"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="flex items-center gap-3 p-4 bg-secondary rounded-2xl text-primary font-semibold hover:opacity-80 transition-opacity"
                  >
