...
import doctorImg from '@assets/IMG-20260309-WA0041_1773231859101.jpg';

export default function Doctor() {
  return (
    <section id="doctor" className="py-16 md:py-24 bg-secondary/50" style={{ overflow: 'hidden' }}>
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          
          <div className="w-full max-w-sm mx-auto lg:mx-0 order-2 lg:order-1">
            <div className="relative rounded-2xl md:rounded-[2rem] overflow-hidden aspect-[4/5] shadow-2xl border-4 border-white">
              <img 
                src={doctorImg} 
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="pl-4 md:pl-6 border-l-4 border-primary italic text-foreground/80 text-sm md:text-base font-medium">
