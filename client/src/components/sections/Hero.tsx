...
export default function Hero() {
  return (
    <section id="home" className="relative pt-24 pb-16 md:pt-32 md:pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-secondary/30">
      {/* Background Decor - Constrained for mobile */}
      <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/4 md:translate-x-1/3 w-[500px] md:w-[800px] h-[500px] md:h-[800px] bg-primary/5 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-0 left-0 translate-y-1/4 md:translate-y-1/3 -translate-x-1/4 md:-translate-x-1/3 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-blue-400/5 rounded-full blur-3xl -z-10" />
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-[1.1] mb-4 sm:mb-6 text-balance">
              Creating Beautiful <span className="text-primary relative inline-block">Smiles<svg className="absolute w-full h-2 sm:h-3 -bottom-0.5 sm:-bottom-1 left-0 text-primary/30" viewBox="0 0 100 10" preserveAspectRatio="none"><path d="M0 5 Q 50 10 100 5" stroke="currentColor" strokeWidth="3" fill="none" /></svg></span> for Everyone
            </h1>
            
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed text-balance">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-8 sm:mb-10">
              <Button asChild size="lg" className="rounded-xl h-12 sm:h-14 px-6 sm:px-8 text-sm sm:text-base shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto">
                <a href="#appointment">
          ...
          <div className="relative mx-auto w-full max-w-lg lg:max-w-none px-4 sm:px-0">
            <div className="relative rounded-2xl sm:rounded-[2.5rem] overflow-hidden aspect-[4/5] shadow-2xl border-4 sm:border-8 border-white">
            ...
            {/* Background shape for image - Hidden on mobile */}
            <div className="hidden sm:block absolute -inset-4 border-2 border-primary/20 rounded-[3rem] -z-10 transform rotate-3 scale-105 transition-transform duration-500 hover:rotate-6" />
          </div>
